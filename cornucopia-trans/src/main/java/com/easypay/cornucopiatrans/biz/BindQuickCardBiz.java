...
@Slf4j
@Service
public class BindQuickCardBiz extends BaseRequestHuifu {
    ...
    public HuiFuResp bindCard(String userId){
            ...
            JSONObject jsonObject = httpClientUtils.doPost(HuiFuUrlEmum.URL_7412.getRequestUrl(),params);
