...
import com.easypay.cornucopiatrans.dal.dao.impl.SequenceMapperImpl;
...
public class SequenceBiz{
     ...
     * @throws Exception
     */
    public String getSeqId(String seqIdName) throws Exception {
        synchronized (SequenceBiz.class) {
             ...
             */
            Long result = queue.poll(200L,TimeUnit.MILLISECONDS);
            if(result == null)
            {
                throw  new Exception("获取序列号超时失败");
            }
